...
function testHeatingPattern(u) {
  ...
  if (/(?:^|[^a-zа-я])(?:klima|клима)(?:ta|та)?(?:$|[^a-zа-я])/i.test(u) || /inverter|инвертер|invertor|инвертор|klima inverter|клима инвертер|термопумпа|toplotna|топлотна|na klima|на клима|se gream|се греам|(?:^|[^a-zа-я])(?:split|сплит)(?:$|[^a-zа-я])/i.test(u)) return "inverter";
